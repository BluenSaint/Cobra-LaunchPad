      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="h-16 w-16 text-teal-600 mb-4 flex items-center justify-center bg-teal-50 p-3 rounded-xl">
                <feature.icon />
              </div>
              <h3 className="text-xl font-semibold text-[#03293d] mb-3">{feature.title}</h3>
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <motion.div
            ...
            className="bg-gradient-to-br from-teal-500 to-teal-700 p-8 rounded-xl text-white shadow-xl"
          >
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-500 to-blue-700 p-8 rounded-xl text-white shadow-xl"
          >
            <div className="flex items-center mb-4">
              <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-purple-500 to-purple-700 p-8 rounded-xl text-white shadow-xl"
          >
            <div className="flex items-center mb-4">
              <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
